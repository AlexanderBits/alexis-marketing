        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-8">
            <Link to="/" className="flex items-center gap-2 group">
              ...
              <span className="text-white font-bold tracking-tight uppercase text-sm">Alexis Admin</span>
            </Link>
                ...
                return (
                  ...
                  >
                    ...
                    {isActive && (
                      <motion.div
                        layoutId="active-nav"
                        className="absolute bottom-0 left-0 right-0 h-0.5 bg-blue-500 md:hidden"
                      />
                    )}
                  </Link>
                );
