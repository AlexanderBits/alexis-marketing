    ...
    <section className="relative min-h-screen flex items-center justify-center bg-slate-950 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center mt-40">
        ...
        <motion.p
          initial={{ opacity: 0, y: 40 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 0.2, ease: "easeOut" }} className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto mb-12 leading-relaxed">Unimos o legado tecnológico da Nortecnet à expertise da Alexis Marketing na construção de sites com máxima indexação no Google. Especialista em impulsionar marcas na Zona Norte de BH, Rio de Janeiro e em todo o Norte do Brasil. Posicionamos você exatamente onde o seu cliente busca — construa seu site, seu portal comigo. Mais que um site: é pura tecnologia.
